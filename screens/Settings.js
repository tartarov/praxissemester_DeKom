...
const DATA = [
  ...
  const Item = ({ item, onPress, backgroundColor, textColor }) => (
    ...
    <TouchableOpacity onPress={onPress} style={[styles.item, backgroundColor]}>
      ...
      <View>
     <Ionicons name="chevron-forward-outline" size={24} style={{color: '#DCD7C9', paddingTop:2}}/>
     </View>
    </TouchableOpacity>
         ...
         <View
          ...
          >
            ...
            <Ionicons
              ...
              style={{ margin: 10 }}
            />
            <CustomText style={{color: '#DCD7C9', fontSize: 25 }}>{data[0].document.name + ", " + data[0].document.vorname }</CustomText>
