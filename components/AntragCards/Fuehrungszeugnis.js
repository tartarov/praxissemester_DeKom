import {
  ...
  function Fuehrungszeugnis({ antragAusstellerDaten }) {
        ...
        <View style={{ flexDirection: "column", opacity: 1 }}>
          ...
          <View style={styles.group}>
            <View style={styles.textContainer}>
              ...
              <Text style={styles.text}>{antragAusstellerDaten.document.rueckverfolgungsnummer}</Text>
            </View>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.text}>{antragAusstellerDaten.document.einreichungsbehoerde}</Text>
          </View>
          <View style={styles.group}>
            <View style={styles.textContainer}>
              <Text style={styles.heading}>Nummer des Ausstellers</Text>
              <Text style={styles.text}>{antragAusstellerDaten.document.ausstellerNummer}</Text>
            </View>
            <View style={{ flexDirection: "column" }}>
              <View
                style={[styles.textContainer, { marginLeft: 100, marginTop: 50 }]}
              >
                <Text style={styles.textCAN}>{antragAusstellerDaten.document.can}</Text>
              </View>
              <View
                style={{
                  alignItems: "center",
